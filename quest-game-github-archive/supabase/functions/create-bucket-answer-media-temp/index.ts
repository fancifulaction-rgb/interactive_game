...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for answer-media" ON storage.objects FOR SELECT USING (bucket_id = 'answer-media');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for answer-media" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'answer-media');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for answer-media" ON storage.objects FOR UPDATE USING (bucket_id = 'answer-media');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for answer-media" ON storage.objects FOR DELETE USING (bucket_id = 'answer-media');`
    ];
