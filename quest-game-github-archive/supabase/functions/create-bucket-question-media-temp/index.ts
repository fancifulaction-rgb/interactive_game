...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "video/*", "audio/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for question-media" ON storage.objects FOR SELECT USING (bucket_id = 'question-media');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for question-media" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'question-media');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for question-media" ON storage.objects FOR UPDATE USING (bucket_id = 'question-media');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for question-media" ON storage.objects FOR DELETE USING (bucket_id = 'question-media');`
    ];
