...
- [ ] **SQL на prod:** `npm run db:migrate:018` · `019` · `020` · `021`
...
- [ ] **npm audit:** 17 CVE (6 moderate · 10 high · 1 critical); `npm audit fix`, retest PDF (jspdf)
...
- [ ] **Smoke на prod URL:** регистрация → игра → табло → архив
