...
- **QA-B04** — длина кода игры 3–10 символов, настройка в админке (feature backlog)
- **QA-G04 / S3** — anon UPDATE `teams.total_score` на test DB (RLS)
...
*Последнее обновление: 2026-06-08 — релиз v1.2.16, retest волна 3.*
